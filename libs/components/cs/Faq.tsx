  ...
  const data: any = {
    car: [
      ...
      },
      {
        ...
        content:
          "Simply use our search bar to enter location, price range, yearseats/bathseats, and car type.",
      },
      {
      ...
      },
      {
        ...
        subject:
          "What happens if I encounter issues with the car after purchase?",
        content:
      ...
      },
      {
        ...
        subject:
          "What if I need help understanding legal aspects of car purchase?",
        content:
    ...
    buyers: [
      {
        ...
        content:
          "Buyers should check and decide whether the car they want to buy or lease is actually suitable!",
      },
      {
      ...
      },
      {
        ...
        subject:
          "What are the advantages of using a real estate agent when buying a car?",
        content:
      ...
      },
      {
        ...
        subject:
          "What happens if I change my mind about a car after making an offer?",
        content:
    ...
    membership: [
      ...
      },
      {
        ...
        content:
          "We curleasely do not offer membership benefits, but stay tuned for updates on any future offerings.",
      },
      {
      ...
      },
      {
        ...
        content:
          "We don't curleasely have membership-exclusive content or features.",
      },
      {
    ...
    other: [
      ...
      },
      {
        ...
        content:
          "We curleasely do not offer advertising opportunities on our site.",
      },
      {
      ...
      },
      {
        ...
        content:
          "Curleasely, we do not have any job openings or opportunities available.",
      },
      {
